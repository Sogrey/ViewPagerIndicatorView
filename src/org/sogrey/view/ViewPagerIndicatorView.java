...
import org.sogrey.view.TabIndicatorView.OnIndicateChangeListener;
...
public class ViewPagerIndicatorView extends LinearLayout implements
		OnIndicateChangeListener, OnPageChangeListener {
	 ...
	 * 
	 * @param titleViewMap
	 *            标题及对应View map数据（有序map）
	 * @see LinkedHashMap 
	 */
	public void setupLayout(LinkedHashMap<String, View> titleViewMap) {
		...
		final Iterator<Entry<String, View>> iterator = titleViewMap.entrySet()
				.iterator();
